...
/usr/share/owlery/bin/owlery -Dowlery.port=8080 -Dowlery.host=0.0.0.0 -Dconfig.file=/srv/conf/application.conf -Dorg.slf4j.simpleLogger.defaultLogLevel=${LOGLEVEL}
